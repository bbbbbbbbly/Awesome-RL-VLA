...
```bibtex
@misc{awesome-rl-vla,
  title={Awesome RL-VLA: A Curated List of Reinforcement Learning for Vision-Language-Action Models},
  author={Your Name},
  year={2025},
  howpublished={\url{https://github.com/yourusername/Awesome-RL-VLA}}
}
```
